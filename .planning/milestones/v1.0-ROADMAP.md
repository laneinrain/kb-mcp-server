# Roadmap Archive: v1.0 Initial Release
...
- [x] **Phase 4: Admin Surfaces & Security** - Web admin, CLI, and optional API key auth with localhost dev defaults
 (completed 2026-07-04)
...
- [x] 04-02-PLAN.md — CLI-01, CLI-02: Commander apps/cli, ingest/list/delete, REST client with Bearer

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-03-PLAN.md — WEB-01–04: Vite/React admin SPA and UI components per UI-SPEC

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 04-04-PLAN.md — Static serve, dev orchestration, turbo build order, E2E checkpoint
...
| 4. Admin Surfaces & Security | 4/4 | Complete | 2026-07-04 |
